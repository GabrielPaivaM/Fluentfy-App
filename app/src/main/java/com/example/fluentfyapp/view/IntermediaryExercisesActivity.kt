...
import com.example.fluentfyapp.databinding.ActivityIntermediaryExercisesBinding
import com.example.fluentfyapp.service.APIInterface
import com.example.fluentfyapp.viewmodel.ExerciseIntermediaryViewModel
import com.example.fluentfyapp.viewmodel.ExerciseIntermediaryViewModelFactory

class IntermediaryExercisesActivity : AppCompatActivity() {
    private lateinit var binding: ActivityIntermediaryExercisesBinding
    private lateinit var viewModel: ExerciseIntermediaryViewModel
    private val retrofitService = APIInterface.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityIntermediaryExercisesBinding.inflate(layoutInflater)
        setContentView(binding.root)
        viewModel = ViewModelProvider(this, ExerciseIntermediaryViewModelFactory(ExerciseRepository(retrofitService))).get(
            ExerciseIntermediaryViewModel::class.java
        )
    }
