...
import com.example.fluentfyapp.databinding.ActivityAdvancedExercisesBinding
import com.example.fluentfyapp.service.APIInterface
import com.example.fluentfyapp.viewmodel.ExerciseAdvancedViewModel
import com.example.fluentfyapp.viewmodel.ExerciseAdvancedViewModelFactory

class AdvancedExercisesActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAdvancedExercisesBinding
    private lateinit var viewModel: ExerciseAdvancedViewModel
    private val retrofitService = APIInterface.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdvancedExercisesBinding.inflate(layoutInflater)
        setContentView(binding.root)
        viewModel = ViewModelProvider(this, ExerciseAdvancedViewModelFactory(ExerciseRepository(retrofitService))).get(
            ExerciseAdvancedViewModel::class.java
        )
    }
