...
class ExerciseBasicViewModel constructor(private val exerciseRepository: ExerciseRepository): ViewModel() {
    ...
    var currencyQuestion = MutableLiveData<Int>()
     ...
     fun getExercise(){
        ...
        exerciseRepository.getRandomExerciseBasic().enqueue(object : Callback<RandomExercise> {
