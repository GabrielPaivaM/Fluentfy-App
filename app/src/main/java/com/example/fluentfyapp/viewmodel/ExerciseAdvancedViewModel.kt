...
class ExerciseAdvancedViewModel constructor(private val exerciseRepository: ExerciseRepository): ViewModel() {
    ...
    fun getExercise(){
        ...
        exerciseRepository.getRandomExerciseAdvanced().enqueue(object : Callback<RandomExercise> {
